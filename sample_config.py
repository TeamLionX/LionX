...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@TeaMlionx/generatestringsession
    ...
    # set this with required lionx repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TeamLionX/LionX"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if EXTERNAL_REPO and not url(EXTERNAL_REPO):
        EXTERNAL_REPO = "https://github.com/TeamLionX/LionXPlugins"
    # if you need lionx plugins use the following vars
    LIONX = bool(os.environ.get("LIONX", False))
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/aa434c6d0e51a2b1e747a.jpg"
    )
