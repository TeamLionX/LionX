...
from . import CMD_HELP, CMD_LIST, SUDO_LIST, lionub, edit_delete, edit_or_reply, reply_id
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "description": "Reply to any external plugin(supported by lion) to install it in your bot.",
        "usage": "{tr}install",
    },
)
