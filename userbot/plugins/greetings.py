...
async def morning(morning):
    ...
    txt = random.choice(lionxmemes.GDMORNING)
...
async def noon(noon):
    ...
    txt = random.choice(lionxmemes.GDNOON)
...
async def night(night):
    ...
    txt = random.choice(lionxmemes.GDNIGHT)
...
async def hi(event):
    ...
    await edit_or_reply(
        event,
        f"{lionx}✨✨{lionx}✨{lionx}{lionx}{lionx}\n{lionx}✨✨{lionx}✨✨{lionx}✨\n{lionx}{lionx}{lionx}{lionx}✨✨{lionx}✨\n{lionx}✨✨{lionx}✨✨{lionx}✨\n{lionx}✨✨{lionx}✨{lionx}{lionx}{lionx}\n☁☁☁☁☁☁☁☁",
    )
