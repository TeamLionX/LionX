...
from . import lionxub, deEmojify, edit_or_reply
...
async def carbon_api(event):
    ...
    await lionx.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await lionx.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await lionx.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await lionx.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await lionx.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await lionx.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await lionx.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await lionx.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await lionx.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await lionx.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
